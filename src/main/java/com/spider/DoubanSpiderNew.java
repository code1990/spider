...
public class DoubanSpiderNew {
    ...
    private String path = "C:\\Users\\Administrator\\Desktop\\ebook\\douban\\";
    private String kw = "量化";
...
//        System.out.println(elementList.size());
        ...
        /*BingSearchUtil.writeTxt(pathTxt, resultList);*/
        /*BingSearchUtil.writeTxt(okTxt, pageNumber+"");*/
        return resultList;
    }
}
